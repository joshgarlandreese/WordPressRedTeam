...
- This command exposed "michael" as the password for the username "michael".  utilizing ssh@192.168.1.110 with password "michael" I was able to gain access to Target 1.  
